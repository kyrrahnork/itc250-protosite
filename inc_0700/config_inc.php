...
$sub_folder = 'itc250-dev-wn20/itc250-wn20/';//If app installed in subfolder, place here.  name of folder, no leading or trailing forward or backslash
...
define('SUPPORT_EMAIL', 'kyrrahnork@gmail.com'); # Email of site support
define('PREFIX', 'winter2020_'); #Adds uniqueness to DB table names.  Limits hackability, naming collisions.  In WordPress the prefix is wp_
